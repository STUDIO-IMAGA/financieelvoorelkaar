...
function toggler( $theme_location = 'primary_navigation' ){
  ...
  $html = '<button class="navbar-toggler ml-auto" type="button" data-toggle="collapse" data-target="#' . $theme_location . '" aria-controls="' . $theme_location . '" aria-expanded="false" aria-label="' . __('Toggle navigation','imaga') . '">';
