  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-7 bg-white-35 px-4 py-2">
        ...
        <p class="lead">Ieder hypotheekadvies is uniek. Of je nu start of doorstroomt op de woningmarkt. Financieel Voor Elkaar heeft voor ieder moment in je leven een duidelijk verhaal.</p>
        <p class="lead">Daarnaast voorzien wij je van een hypotheek-voorstel en ook financieel advies.</p>
  ...
  <div class="container py-6">
    ...
    <div class="row">
      <div class="col-12 col-md-6">
        <img class="img-fluid" src="<?= Assets\asset_path("images/fve-2.jpg"); ?>"/>
      </div>
      <div class="col-12 col-md-6">
